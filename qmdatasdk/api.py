...
def get_price(security, start_date=None, end_date=None, frequency='daily', fields=None,
    ...
    return QMDataClient.instance().get_price(**locals())
...
def get_price_engine(security, start_date=None, end_date=None,
    ...
    return QMDataClient.instance().get_price_engine(**locals())
...
def get_extras(info, security_list, start_date=None, end_date=None, df=True, count=None):
    ...
    return QMDataClient.instance().get_extras(**locals())
...
def get_fundamentals(query_object, date=None, statDate=None):
    ...
    if date == datetime.date.today() or date == datetime.date.today().strftime("%Y-%m-%d"):
        """ 当天的数据可能变化,不用缓存 """
        return QMDataClient.instance().get_fundamentals(sql=sql)
...
def get_fundamentals_continuously(query_object, end_date=None, count=1, panel=True):
    ...
    df = QMDataClient.instance().get_fundamentals_continuously(sql=sql)
    if panel:
...
def get_valuation(security_list, start_date=None, end_date=None, fields=None, count=None):
    ...
    end_date = to_date_str(end_date)
    security_list = convert_security(security_list)
    return QMDataClient.instance().get_valuation(**locals())
...
def get_index_valuation(security_list, start_date=None, end_date=None, fields=None, count=None):
    ...
    end_date = to_date_str(end_date)
    security_list = convert_security(security_list)
    return QMDataClient.instance().get_index_valuation(**locals())
...
def get_history_fundamentals(security, fields, watch_date=None, stat_date=None,
    ...
    return QMDataClient.instance().get_history_fundamentals(**locals())
...
def get_billboard_list(stock_list=None, start_date=None, end_date=None, count=None):
    ...
    return QMDataClient.instance().get_billboard_list(**locals())
...
def get_locked_shares(stock_list=None, start_date=None, end_date=None, forward_count=None):
    ...
    end_date = to_date_str(end_date)
    stock_list = convert_security(stock_list)
    return QMDataClient.instance().get_locked_shares(**locals())
...
def get_index_stocks(index_symbol, date=today()):
    ...
    return QMDataClient.instance().get_index_stocks(**locals())
...
def get_industry_stocks(industry_code, date=today()):
    ...
    date = to_date_str(date)
    return QMDataClient.instance().get_industry_stocks(**locals())
...
def get_industries(name='zjw', date=None):
    ...
    date = to_date_str(date)
    return QMDataClient.instance().get_industries(**locals())
...
def get_concept_stocks(concept_code, date=today()):
    ...
    date = to_date_str(date)
    return QMDataClient.instance().get_concept_stocks(**locals())
...
def get_concepts():
    ...
    """
    return QMDataClient.instance().get_concepts(**locals())
...
def get_concept(security, date):
    ...
    """
    date = to_date_str(date)
    return QMDataClient.instance().get_concept(**locals())
...
def get_all_securities(types=[], date=None):
    ...
    """
    date = to_date_str(date)
    return QMDataClient.instance().get_all_securities(**locals())
...
def get_security_info(code, date=None):
    ...
    date = to_date_str(date)
    result = QMDataClient.instance().get_security_info(**locals())
    if result:
...
def get_all_trade_days():
    ...
    """
    data = QMDataClient.instance().get_all_trade_days()
...
def get_trade_days(start_date=None, end_date=None, count=None):
    ...
    start_date = to_date_str(start_date)
    end_date = to_date_str(end_date)
    data = QMDataClient.instance().get_trade_days(**locals())
    if str(data.dtype) != "object":
        data = data.astype(datetime.datetime)
    return data
...
def get_money_flow(security_list, start_date=None, end_date=None, fields=None, count=None):
    ...
    start_date = to_date_str(start_date)
    end_date = to_date_str(end_date)
    return QMDataClient.instance().get_money_flow(**locals())
...
def get_money_flow_pro(security_list, start_date=None, end_date=None,
    ...
    if count and start_date:
        raise ParamsError("(start_date, count) only one param is required")
    return QMDataClient.instance().get_money_flow_pro(**locals())
...
def get_mtss(security_list, start_date=None, end_date=None, fields=None, count=None):
    ...
    end_date = to_date_str(end_date)
    security_list = convert_security(security_list)
    return QMDataClient.instance().get_mtss(**locals())
...
def get_margincash_stocks(date=None):
    ...
    """
    date = to_date_str(date)
    return QMDataClient.instance().get_margincash_stocks(**locals())
...
def get_marginsec_stocks(date=None):
    ...
    """
    date = to_date_str(date)
    return QMDataClient.instance().get_marginsec_stocks(**locals())
...
def get_future_contracts(underlying_symbol, date=None):
    ...
    dt = to_date_str(date)
    return QMDataClient.instance().get_future_contracts(underlying_symbol=underlying_symbol, dt=dt)
...
def get_ticks(security, start_dt=None, end_dt=None, count=None, fields=None, skip=True, df=True):
    ...
    return QMDataClient.instance().get_ticks(**locals())
...
def get_ticks_engine(security, start_dt=None, end_dt=None, count=None, fields=None):
    start_dt = to_date_str(start_dt)
    end_dt = to_date_str(end_dt)
    return QMDataClient.instance().get_ticks_engine(**locals())
...
def get_baidu_factor(category=None, day=None, stock=None, province=None):
    ...
    return QMDataClient.instance().get_baidu_factor(**locals())
...
def normalize_code(code):
    ...
    """
    return QMDataClient.instance().normalize_code(**locals())
...
def get_factor_values(securities, factors, start_date=None, end_date=None, count=None):
    ...
    if count and start_date:
        raise ParamsError("(start_date, count) only one param is required")
    return QMDataClient.instance().get_factor_values(**locals())
...
def get_index_weights(index_id, date=None):
    ...
    date = to_date_str(date)
    return QMDataClient.instance().get_index_weights(**locals())
...
def get_industry(security, date=None, df=False):
    ...
    security = convert_security(security)
    date = to_date_str(date)
    return QMDataClient.instance().get_industry(**locals())
...
def get_bars(security, count=None, unit="1d", fields=("date", "open", "high", "low", "close"),
    ...
    return QMDataClient.instance().get_bars(**locals())
...
def get_bars_engine(security, count, unit="1d", fields=("open", "high", "low", "close"), include_now=False, end_dt=None,
    ...
    end_dt = to_date_str(end_dt)
    return QMDataClient.instance().get_bars_engine(**locals())


def _request_http_current_tick(security):
    client = QMDataClient.instance()
...
def get_today_tick_period(security, start_date=None, end_date=None):
    ...
    return QMDataClient.instance().get_today_tick_period(**locals())
...
def get_current_tick_engine(security):
    ...
    if not (isinstance(security, six.string_types) or isinstance(security, (tuple, list))):
        raise Exception('security 必须是字符串 或者 字符串数组')
    security = convert_security(security)
    return QMDataClient.instance().get_current_tick_engine(**locals())
...
def get_fund_info(security, date=None):
    ...
    security = convert_security(security)
    date = to_date_str(date)
    return QMDataClient.instance().get_fund_info(**locals())
...
def get_futures_info(securities=None, fields=('contract_multiplier',
    ...
    securities = convert_security(securities)
    return QMDataClient.instance().get_futures_info(**locals())
...
def get_query_count(field=None):
    ...
    return QMDataClient.instance().get_query_count(**locals())
...
def history_engine(end_dt, count, unit='1d', field='avg', security_list=None,
    ...
    return QMDataClient.instance().history_engine(**locals())
...
def attribute_history_engine(end_dt, security, count, unit='1d',
    ...
    end_dt = to_date_str(end_dt)
    pre_factor_ref_date = to_date_str(pre_factor_ref_date)
    return QMDataClient.instance().attribute_history_engine(**locals())
...
def get_daily_info_engine(security, date=None):
    ...
    security = convert_security(security)
    date = to_date_str(date)
    return QMDataClient.instance().get_daily_info_engine(**locals())
...
def get_factor_effect(security, start_date, end_date, period, factor, group_num=5):
    ...
    return QMDataClient.instance().get_factor_effect(**locals())


@assert_auth
@hashable_lru(maxsize=3)
def get_all_factors():
    return QMDataClient.instance().get_all_factors(**locals())
...
def get_call_auction(security, start_date, end_date, fields=None):
    ...
    if start_date[:10] >= today_str():
        if get_now().now().time() < datetime.time(9, 30):
            # 当天9:30之前数据可能变化, 不用缓存
            return QMDataClient.instance().get_call_auction(**locals())
...
def exec_call_auction(security,start_date=None, end_date=None, fields=None):
    return QMDataClient.instance().get_call_auction(security=security,
...
def get_factor_kanban_values(universe=None, bt_cycle=None, category=None, model='long_only', **kwargs):
    ...
    return QMDataClient.instance().get_factor_kanban_values(
            universe=universe,
            bt_cycle=bt_cycle,
            category=category,
            model=model,
...
def get_factor_style_returns(factors=None, start_date=None,
    ...
    start_date = to_date_str(start_date)
    end_date = to_date_str(end_date)
    return QMDataClient.instance().get_factor_style_returns(**locals())
...
def get_factor_specific_returns(security, start_date=None, end_date=None,
    ...
    start_date = to_date_str(start_date)
    end_date = to_date_str(end_date)
    return QMDataClient.instance().get_factor_specific_returns(**locals())
...
def get_factor_stats(factor_names=None, universe_type='hs300',
    ...
    start_date = to_date_str(start_date)
    end_date = to_date_str(end_date)
    return QMDataClient.instance().get_factor_stats(**locals())
...
def get_factor_cov(start_date, end_date,
    ...
    start_date = to_date_str(start_date)
    end_date = to_date_str(end_date)
    return QMDataClient.instance().get_factor_cov(**locals())
...
def get_all_alpha_101(date, code=None, alpha=None):
    ...
    return QMDataClient.instance().get_all_alpha_101(**locals())
...
def get_all_alpha_191(date, code=None, alpha=None):
    ...
    return QMDataClient.instance().get_all_alpha_191(**locals())
...
def get_order_future_bar(symbol,
    ...
    if not isinstance(fields, (list, tuple, set)):
        fields = [fields]
    return QMDataClient.instance().get_order_future_bar(**locals())
...
def get_table_info(table):
    ...
    if isinstance(table, six.string_types):
        ...
        # 处理参数直接为数据库表名字符串的情况
            ...
            return QMDataClient.instance().get_table_info(table=table)
    ...
    # 处理形式如 finance.STK_INCOME_STATEMENT 等 ORM 对象
        ...
        return QMDataClient.instance().get_table_info(table=table.__tablename__)
    else:
...
def get_preopen_infos(security, fields=("paused", "factor", "high_limit", "low_limit")):
    ...
    """
    security = convert_security(security)
    return QMDataClient.instance().get_preopen_infos(**locals())
...
def get_history_industry(name, securities=None):
    ...
    """
    securities = convert_security(securities)
    return QMDataClient.instance().get_history_industry(**locals())
...
def get_index_style_exposure(index, factors=None,
    ...
    return QMDataClient.instance().get_index_style_exposure(**locals())
...
def get_data(api_name, **kwargs):
    ...
    """
    assert api_name
    return QMDataClient.instance().get_data(api_name=api_name, args=kwargs)


def get_account_info():
    """获取账号明细"""
    return QMDataClient.instance().get_account_info()


def get_privilege():
    """获取当前拥有的权限"""
    return QMDataClient.instance().get_privilege()


def get_now_time():
    """获取服务器当前时间戳"""
    return QMDataClient.instance().get_now_time()


def get_server_version():
    """获取服务器版本"""
    try:
        version = QMDataClient.instance().get_server_version()
    except Exception:
        version = "1.0"
    return version
...
def get_test():
    """测试连通性"""
    return QMDataClient.instance().get_test()
...
def test_network_speed(size=10000000, count=5):
    ...
    返回结果单位为 M/s
    """
    return QMDataClient.instance().test_network_speed(size=size, count=count)
